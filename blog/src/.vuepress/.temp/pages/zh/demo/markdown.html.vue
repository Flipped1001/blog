...
<div class="language-js line-numbers-mode" data-ext="js" data-title="js"><pre v-pre class="shiki shiki-themes github-light one-dark-pro vp-code" style="background-color:#fff;--shiki-dark-bg:#282c34;color:#24292e;--shiki-dark:#abb2bf" tabindex="0"><code><span class="line"><span style="color:#D73A49;--shiki-dark:#C678DD">const</span><span style="color:#005CC5;--shiki-dark:#E5C07B"> a</span><span style="color:#D73A49;--shiki-dark:#56B6C2"> =</span><span style="color:#005CC5;--shiki-dark:#D19A66"> 1</span><span style="color:#24292E;--shiki-dark:#ABB2BF">;</span></span></code></pre>
<div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></div>
...
<template #tab0="{ value, isActive }">
<div class="language-bash line-numbers-mode" data-ext="bash" data-title="bash"><pre v-pre class="shiki shiki-themes github-light one-dark-pro vp-code" style="background-color:#fff;--shiki-dark-bg:#282c34;color:#24292e;--shiki-dark:#abb2bf" tabindex="0"><code><span class="line"><span style="color:#6F42C1;--shiki-dark:#61AFEF">pnpm</span><span style="color:#032F62;--shiki-dark:#98C379"> add</span><span style="color:#005CC5;--shiki-dark:#D19A66"> -D</span><span style="color:#032F62;--shiki-dark:#98C379"> vuepress-theme-hope</span></span></code></pre>
<div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></template>
<template #tab1="{ value, isActive }">
<div class="language-bash line-numbers-mode" data-ext="bash" data-title="bash"><pre v-pre class="shiki shiki-themes github-light one-dark-pro vp-code" style="background-color:#fff;--shiki-dark-bg:#282c34;color:#24292e;--shiki-dark:#abb2bf" tabindex="0"><code><span class="line"><span style="color:#6F42C1;--shiki-dark:#61AFEF">yarn</span><span style="color:#032F62;--shiki-dark:#98C379"> add</span><span style="color:#005CC5;--shiki-dark:#D19A66"> -D</span><span style="color:#032F62;--shiki-dark:#98C379"> vuepress-theme-hope</span></span></code></pre>
<div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></template>
<template #tab2="{ value, isActive }">
<div class="language-bash line-numbers-mode" data-ext="bash" data-title="bash"><pre v-pre class="shiki shiki-themes github-light one-dark-pro vp-code" style="background-color:#fff;--shiki-dark-bg:#282c34;color:#24292e;--shiki-dark:#abb2bf" tabindex="0"><code><span class="line"><span style="color:#6F42C1;--shiki-dark:#61AFEF">npm</span><span style="color:#032F62;--shiki-dark:#98C379"> i</span><span style="color:#005CC5;--shiki-dark:#D19A66"> -D</span><span style="color:#032F62;--shiki-dark:#98C379"> vuepress-theme-hope</span></span></code></pre>
<div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></template>
</CodeTabs>
<ul>

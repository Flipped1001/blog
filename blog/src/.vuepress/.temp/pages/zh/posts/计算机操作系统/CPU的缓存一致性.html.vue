<template><div><!-- more -->
<h3 id="cpu-cache-的数据写入" tabindex="-1"><a class="header-anchor" href="#cpu-cache-的数据写入"><span>CPU Cache 的数据写入</span></a></h3>
...
<h4 id="写直达" tabindex="-1"><a class="header-anchor" href="#写直达"><span>写直达</span></a></h4>
...
<h4 id="写回" tabindex="-1"><a class="header-anchor" href="#写回"><span>写回</span></a></h4>
<p>在写回机制中，<strong>当发生写操作时，新的数据仅仅被写入 Cache Block 里，只有当修改过的 Cache Block「被替换」时才需要写到内存中</strong>，减少了数据写回内存的频率，这样便可以提高系统的性能。</p>
<img src="https://s21.ax1x.com/2024/05/22/pkMRsxS.png" width="500" height="700">
<ul>
...
<p>左半部分就是读操作的流程，右半部分就是写操作的流程：</p>
<img src="https://s21.ax1x.com/2024/05/22/pkMRgbj.png" width="500" height="500">
<h3 id="缓存一致性问题" tabindex="-1"><a class="header-anchor" href="#缓存一致性问题"><span>缓存一致性问题</span></a></h3>
...
<p>那么，要解决这一问题，就需要一种机制，来同步两个不同核心里面的缓存数据。</p>
<ul>
...
<hr>
<h4 id="总线嗅探" tabindex="-1"><a class="header-anchor" href="#总线嗅探"><span>总线嗅探</span></a></h4>
...
<h4 id="mesi-协议" tabindex="-1"><a class="header-anchor" href="#mesi-协议"><span>MESI 协议</span></a></h4>
...
<p>事实上，整个 MESI 的状态可以用一个有限状态机来表示它的状态流转。下图即是 MESI 协议的状态图：</p>
<img src="https://s21.ax1x.com/2024/05/22/pkMWZJP.png" width="500">
<p>MESI 协议的四种状态之间的流转过程：</p>
<img src="https://s21.ax1x.com/2024/05/22/pkMWAII.png" width="500" height="700"></div></template>
